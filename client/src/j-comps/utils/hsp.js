...
export const hsp = {
  ...
  applyTheme: function (params) {
    ...
    style.href =
      'https://d2l6uygi1pgnys.cloudfront.net/jsapi/4-0/assets/css/ad_default.css'
    style.onload = function () {
      // only IE supports this, which is good cause checking style doesn't work
      fnDone()
    }
...
//FACEBOOK POST
{
  "post": {
    ...
    "content": {
      "body": "These social media apps are the best of the best ðŸ‘",
      "bodyhtml": "These social media apps are the best of the best ðŸ‘"
    },
    "user": {
      "userid": "177463958820",
      "username": "Hootsuite"
    ...
    "attachments": [
      {
        ...
        "title": "10 Social Media Apps You Should Be Using in 2016 (But Probably Arenâ€™t)",
...
// INSTAGRAM
{
  "post": {
    ...
    "content": {
      "body": "#TBT to sunshine, kiddie pools & #hootroof â˜€ï¸ #hootsuitelife ðŸ“·: @jlovebomb",
      "bodyhtml": "#TBT to sunshine, kiddie pools & #hootroof â˜€ï¸ #hootsuitelife ðŸ“·: @jlovebomb"
    },
    "user": {
      "userid": "2182934",
      "username": "hootsuite"
  ...
  "profile": {
    ...
    "bio": "A look inside Hootsuiteâ€”the world's most widely used platform for managing social media. #hootsuitelife",
