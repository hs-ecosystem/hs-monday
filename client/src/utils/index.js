...
import YoutubeIcon from '../__App__/Dashboard/DashboardBody/FieldMapper/SocialProfilePicker/ProfilesList/SocialNetworkIcons/yt-icon.png'
...
export const getNetworkIcon = (network) => {
  try {
    ...
    if (network === 'FACEBOOKPAGE') return FacebookIcon
